...
echo ""
./jcl_parser.sh jobs/hello_world.jcl 2>/dev/null || echo "JCL parsed (COBOL compiler not available - using simulation)"
echo ""
...
echo "4. Create your own JCL jobs and COBOL programs"
echo "5. Practice: Modify hello_world.jcl for different scenarios"
echo ""
